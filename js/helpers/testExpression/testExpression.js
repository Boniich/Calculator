const testExpression = (stateCopy,typeOperation) =>{
    ...
    switch (typeOperation) {
        //fractions
        case "2f":
            expression = /(1\/\(\-?[0-9 | .]+\)).(1\/\(\-?[0-9 | .]+\))/g;
            break;
        case "nf":
            expression = /(\-?[0-9 | .]+.1\/\(\-?[0-9 | .]+\))/g;
            break;
        case "fn":
            expression = /(1\/\(\-?[0-9 | .]+\).$)/g;
            break;
        //potency 
        case "pp":
            expression = /(sqr\(\-?[0-9 | .]+\)).(sqr\(\-?[0-9 | .]+\))/g;
            break;
        case "np":
            expression = /(\-?[0-9 | .]+).(sqr\(\-?[0-9 | .]+\))/g
            break;
        case "pn":
            expression = /(sqr\(\-?[0-9 | .]+\).$)/g;
            break;
        //square root
        case "ss":
            expression = /(√\([0-9 | .]+\)).(√\([0-9 | .]+\))/g;
            break;
        case "ns":
            expression = /(\-?[0-9 | .]+).(√\([0-9 | .]+\))/g
            break;
        ...
        case "fp":
            expression = /(1\/\(\-?[0-9 | .]+\)).(sqr\(\-?[0-9 | .]+\))/g;
            break;
        case "pf":
            expression = /(sqr\(\-?[0-9 | .]+\)).(1\/\(\-?[0-9 | .]+\))/g;
            break;
        case "fs":
            expression = /(1\/\(\-?[0-9 | .]+\)).(√\([0-9 | .]+\))/g;
            break;
        case "sf":
            expression = /(√\([0-9 | .]+\)).(1\/\(\-?[0-9 | .]+\))/g;
            break;
